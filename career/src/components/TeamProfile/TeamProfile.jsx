...
// Color map with the correct layered shades
const colorMap = {
    green: {
                    ...
                    <div className="lg:col-span-9 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className={`p-4 ${colors.bgBox} rounded-lg border dark:border-slate-600`}>
                                ...
                                {mainMember.personality && mainMember.personality.map(item => (
                            ...
                            <div className={`p-4 ${colors.bgBox} rounded-lg border dark:border-slate-600`}>
                                ...
                                <ul className="list-disc list-inside text-sm text-gray-700 dark:text-gray-300 space-y-1">
                                    {mainMember.goals && mainMember.goals.map((goal, index) => (
                        ...
                        <div className="space-y-6">
                            ...
                            <div className={`p-4 ${colors.bgBox} rounded-lg border dark:border-slate-600`}>
                                <h4 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">{t('teamProfile_team')}</h4>
