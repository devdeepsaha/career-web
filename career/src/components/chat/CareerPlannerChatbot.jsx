        ...
        <>
            ...
            {!isFullscreen && (
                <button
                    ...
                    className="fixed bottom-20 md:bottom-6 right-6 bg-indigo-600 text-white p-4 rounded-full shadow-lg hover:bg-indigo-700 transition-transform transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 z-10"
            ...
            {isOpen && (
                <div
                    ...
                    className={`fixed bg-white dark:bg-slate-800 rounded-2xl shadow-2xl flex flex-col border border-gray-200 dark:border-slate-700 z-10 transition-all duration-300 ease-in-out origin-bottom-right
                    ${isFullscreen
